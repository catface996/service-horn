package com.catface.horn.repository.generator;
...
import com.catface.horn.BaseTest;
...
public class GeneratorServiceEntity extends BaseTest {
    ...
    private final String packageName = "com.catface.horn.repository";
    ...
    public void generateOnlyEntity() {
        generateEntity(serviceNameStartWithI, packageName, "demo_table");
    }
